...
import { VOID_TOGGLE_SETTINGS_ACTION_ID } from './mcodeSettingsPane.js';
...
registerAction2(class extends Action2 {
	constructor() {
		super({ id: VOID_OPEN_SIDEBAR_ACTION_ID, title: localize2('voidOpenSidebar', 'MCode: Open Sidebar'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidCmdL', 'MCode: Add Selection to Chat'),
			keybinding: {
