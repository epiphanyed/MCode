...
class VoidSettingsService extends Disposable implements IVoidSettingsService {
	...
	async readAndInitializeState() {
		...
		try {
			...
			if (readS.globalSettings.milvusUrl === undefined) readS.globalSettings.milvusUrl = 'localhost:19530';
			if (readS.globalSettings.milvusUsername === undefined) readS.globalSettings.milvusUsername = '';
			if (readS.globalSettings.milvusPassword === undefined) readS.globalSettings.milvusPassword = '';
			if (readS.globalSettings.embeddingProvider === undefined) readS.globalSettings.embeddingProvider = 'ollama';
			if (readS.globalSettings.embeddingModel === undefined) readS.globalSettings.embeddingModel = 'nomic-embed-text';
			if (readS.globalSettings.ollamaEndpoint === undefined) readS.globalSettings.ollamaEndpoint = 'http://127.0.0.1:11434';
			if (readS.globalSettings.ragSimilarityTopK === undefined) readS.globalSettings.ragSimilarityTopK = 12;
			if (readS.globalSettings.ragFinalTopK === undefined) readS.globalSettings.ragFinalTopK = 5;
			if (readS.globalSettings.ragUseReranker === undefined) readS.globalSettings.ragUseReranker = true;
			if (readS.globalSettings.ragMilvusDualWrite === undefined) readS.globalSettings.ragMilvusDualWrite = false;
			if (readS.globalSettings.ragUseOrchestrator === undefined) readS.globalSettings.ragUseOrchestrator = true;
			if (readS.globalSettings.ragUseSubQuestions === undefined) readS.globalSettings.ragUseSubQuestions = true;
			if (readS.globalSettings.ragUseLlmSubQuestions === undefined) readS.globalSettings.ragUseLlmSubQuestions = false;
			if (readS.globalSettings.ragUseRouter === undefined) readS.globalSettings.ragUseRouter = true;
			if (readS.globalSettings.ragUseGraphExpand === undefined) readS.globalSettings.ragUseGraphExpand = true;
			if (readS.globalSettings.ragGraphExpandHops === undefined) readS.globalSettings.ragGraphExpandHops = 1;
			if (readS.globalSettings.ragGraphExpandMax === undefined) readS.globalSettings.ragGraphExpandMax = 4;
			if (readS.globalSettings.ragUseDocLinkedCode === undefined) readS.globalSettings.ragUseDocLinkedCode = true;
			if (readS.globalSettings.ragContextMaxChars === undefined) readS.globalSettings.ragContextMaxChars = 12_000;
			if (readS.globalSettings.ragLspBudgetRatio === undefined) readS.globalSettings.ragLspBudgetRatio = 0.3;
			if (readS.globalSettings.ragGitContextMaxChars === undefined) readS.globalSettings.ragGitContextMaxChars = 2_000;
			if (readS.globalSettings.ragCompactMode === undefined) readS.globalSettings.ragCompactMode = false;
			if (readS.globalSettings.ragIntentOrchestration === undefined) readS.globalSettings.ragIntentOrchestration = true;
		}
		catch (e) {
			readS = defaultState()
		}
