...
import { VoidSettingsState } from './mcodeSettingsService.js'
...
export type GlobalSettings = {
	...
	ragSimilarityTopK: number;
	ragFinalTopK: number;
	ragUseReranker: boolean;
	/** Mirror Milvus writes to local disk index during migration. */
	ragMilvusDualWrite: boolean;
	/** Phase 10: RAG orchestration toggles. */
	ragUseOrchestrator: boolean;
	ragUseSubQuestions: boolean;
	ragUseLlmSubQuestions: boolean;
	ragUseRouter: boolean;
	ragUseGraphExpand: boolean;
	ragGraphExpandHops: number;
	ragGraphExpandMax: number;
	ragUseDocLinkedCode: boolean;
	/** Phase 12: merged RAG context character budget for Chat. */
	ragContextMaxChars: number;
	/** Phase 12: LSP share of context budget after Git section (0–1). */
	ragLspBudgetRatio: number;
	/** Phase 12: max chars for Git dynamic diff/log context. */
	ragGitContextMaxChars: number;
	/** Phase 12: compact long code chunks in RAG output. */
	ragCompactMode: boolean;
	/** Phase 12: auto-lite orchestration on simple queries. */
	ragIntentOrchestration: boolean;
	/** Phase 9: route simple/debug queries to alternate chat models. */
...
export const defaultGlobalSettings: GlobalSettings = {
	...
	ragFinalTopK: 3,
	ragUseReranker: true,
	ragMilvusDualWrite: false,
	ragUseOrchestrator: true,
	ragUseSubQuestions: true,
	ragUseLlmSubQuestions: false,
	ragUseRouter: true,
	ragUseGraphExpand: true,
	ragGraphExpandHops: 1,
	ragGraphExpandMax: 4,
	ragUseDocLinkedCode: true,
	ragContextMaxChars: 12_000,
	ragLspBudgetRatio: 0.3,
	ragGitContextMaxChars: 2_000,
	ragCompactMode: false,
	ragIntentOrchestration: true,
	modelIntentRoutingEnabled: false,
	modelRouterFastProvider: '',
	modelRouterFastModel: '',
	modelRouterReasoningProvider: '',
	modelRouterReasoningModel: '',
}
