...
export type BuiltinToolCallParams = {
	...
	'open_persistent_terminal': { cwd: string | null, command?: string },
...
export type BuiltinToolResultType = {
	...
	'open_persistent_terminal': { persistentTerminalId: string, result?: string, resolveReason?: TerminalResolveReason },
