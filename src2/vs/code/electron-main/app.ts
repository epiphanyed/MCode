...
import { IVoidUpdateService } from '../../workbench/contrib/mcode/common/mcodeUpdateService.js';
import { MetricsMainService } from '../../workbench/contrib/mcode/electron-main/metricsMainService.js';
import { VoidMainUpdateService } from '../../workbench/contrib/mcode/electron-main/mcodeUpdateMainService.js';
import { LLMMessageChannel } from '../../workbench/contrib/mcode/electron-main/sendLLMMessageChannel.js';
import { VoidSCMService } from '../../workbench/contrib/mcode/electron-main/mcodeSCMMainService.js';
import { IVoidSCMService } from '../../workbench/contrib/mcode/common/mcodeSCMTypes.js';
import { MCPChannel } from '../../workbench/contrib/mcode/electron-main/mcpChannel.js';
import { PtyChannel } from '../../workbench/contrib/mcode/electron-main/ptyManager.js';
import { IVoidRagService } from '../../workbench/contrib/mcode/common/mcodeRagTypes.js';
import { VoidRagService } from '../../workbench/contrib/mcode/electron-main/mcodeRagMainService.js';
import { IVoidDiagramService } from '../../workbench/contrib/mcode/common/mcodeDiagramTypes.js';
import { VoidDiagramService } from '../../workbench/contrib/mcode/electron-main/mcodeDiagramMainService.js';
/**
...
export class CodeApplication extends Disposable {
	...
	private async initServices(machineId: string, sqmId: string, devDeviceId: string, sharedProcessReady: Promise<MessagePortClient>): Promise<IInstantiationService> {
		...
		services.set(IVoidRagService, new SyncDescriptor(VoidRagService, undefined, false));
		services.set(IVoidDiagramService, new SyncDescriptor(VoidDiagramService, undefined, false));
	...
	private initChannels(accessor: ServicesAccessor, mainProcessElectronServer: ElectronIPCServer, sharedProcessClient: Promise<MessagePortClient>): void {
		...
		// Void added this
		const ptyChannel = new PtyChannel();
		mainProcessElectronServer.registerChannel('void-channel-pty', ptyChannel);
		...
		// Void added this
		const voidDiagramChannel = ProxyChannel.fromService(accessor.get(IVoidDiagramService), disposables);
		mainProcessElectronServer.registerChannel('void-channel-diagram', voidDiagramChannel);
