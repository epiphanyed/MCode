...
// The extension this was called from is here - https://github.com/voideditor/mcode/blob/autocomplete/extensions/mcode/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	async _provideInlineCompletionItems(
		...
		try {
			...
			relevantContext = relevantSnippetsList.join('\n---\n')
		} catch (e) {
			console.warn('[Autocomplete] LSP context gathering failed:', e)
		}
