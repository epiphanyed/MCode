...
import { McodeCommandBarProps } from '../../../mcodeCommandBarService.js';
...
export const McodeCommandBarMain = ({ uri, editor }: McodeCommandBarProps) => {
  const isDark = useIsDark();

  return <div
    className={`void-scope ${isDark ? "void-dark" : ""}`}>
    
		<McodeCommandBar uri={uri} editor={editor} />
	</div>;
};
...
export const McodeCommandBar = ({ uri, editor }: McodeCommandBarProps) => {
  ...
  const mcodeModelService = accessor.get('IVoidModelService');
