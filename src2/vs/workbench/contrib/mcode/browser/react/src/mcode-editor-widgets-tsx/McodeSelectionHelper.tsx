...
import { McodeSelectionHelperProps } from '../../../../../../contrib/mcode/browser/mcodeSelectionHelperWidget.js';
import { VOID_OPEN_SETTINGS_ACTION_ID } from '../../../mcodeSettingsPane.js';


export const McodeSelectionHelperMain = (props: McodeSelectionHelperProps) => {
  ...
  return <div
    className={`void-scope ${isDark ? "void-dark" : ""}`}>
		...
		<McodeSelectionHelper {...props} />
	</div>;
};



const McodeSelectionHelper = ({ rerenderKey }: McodeSelectionHelperProps) => {
