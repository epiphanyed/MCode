...
import { displayInfoOfProviderName, ProviderName, providerNames, localProviderNames, featureNames, FeatureName, isFeatureNameDisabled } from '../../../../common/mcodeSettingsTypes.js';
import { ChatMarkdownRender } from '../markdown/ChatMarkdownRender.js';
import { OllamaSetupInstructions, OneClickSwitchButton, SettingsForProvider, ModelDump } from '../mcode-settings-tsx/Settings.js';
  ...
  return <div className="void-flex void-flex-col md:void-flex-row void-w-full void-h-[80vh] void-gap-6 void-max-w-[900px] void-mx-auto void-relative">
      ...
      <div key={providerName} className="void-w-full void-max-w-xl void-mb-10">
					<div className="void-text-xl void-mb-2">
						...
						{providerName === 'gemini' &&
          <span
            data-tooltip-id="mcode-tooltip-provider-info"
...
const McodeOnboardingContent = () => {
  ...
  const lastPagePrevAndNextButtons = <div className="void-max-w-[600px] void-w-full void-mx-auto void-flex void-flex-col void-items-end">
        ...
        onClick={() => {setPageIndex(pageIndex - 1);}} />
			...
			<PrimaryActionButton
        onClick={() => {
          mcodeSettingsService.setGlobalSetting('isOnboardingComplete', true);
          voidMetricsService.capture('Completed Onboarding', { selectedProviderName, wantToUseOption });
        }}
        ringSize={voidSettingsState.globalSettings.isOnboardingComplete ? 'screen' : undefined}>
        Enter MCode</PrimaryActionButton>
		</div>
	</div>;
  ...
  const detailedDescOfWantToUseOption: { [wantToUseOption in WantToUseOption]: string } = {
    ...
    private: "Private-hosted so your data never leaves your computer or network. Please refer to our documentation for help setting up at your company.",
  ...
  const contentOfIdx: {[pageIndex: number]: React.ReactNode;} = {
    0: <OnboardingPageShell
      ...
      <div className="void-flex void-flex-col void-items-center void-gap-8">
					<div className="void-text-5xl void-font-light void-text-center">Welcome to MCode</div>
