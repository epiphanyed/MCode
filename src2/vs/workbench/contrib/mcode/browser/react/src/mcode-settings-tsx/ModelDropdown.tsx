...
import { FeatureName, featureNames, isFeatureNameDisabled, ModelSelection, modelSelectionsEqual, ProviderName, providerNames, SettingsOfProvider } from '../../../../../../../workbench/contrib/mcode/common/mcodeSettingsTypes.js';
import { useSettingsState, useRefreshModelState, useAccessor } from '../util/services.js';
import { _VoidSelectBox, VoidCustomDropdownBox } from '../util/inputs.js';
import { SelectBox } from '../../../../../../../base/browser/ui/selectBox/selectBox.js';
import { IconWarning } from '../sidebar-tsx/SidebarChat.js';
import { VOID_OPEN_SETTINGS_ACTION_ID, VOID_TOGGLE_SETTINGS_ACTION_ID } from '../../../mcodeSettingsPane.js';
import { modelFilterOfFeatureName, ModelOption } from '../../../../../../../workbench/contrib/mcode/common/mcodeSettingsService.js';
...
const ModelSelectBox = ({ options, featureName, className }: {options: ModelOption[];featureName: FeatureName;className: string;}) => {
  ...
  const selection = mcodeSettingsService.state.modelSelectionOfFeature[featureName];
  const selectedOption = selection ? mcodeSettingsService.state._modelOptions.find((v) => modelSelectionsEqual(v.selection, selection))! : options[0];

  const onChangeOption = useCallback((newOption: ModelOption) => {
    mcodeSettingsService.setModelSelectionOfFeature(featureName, newOption.selection);
  }, [mcodeSettingsService, featureName]);
