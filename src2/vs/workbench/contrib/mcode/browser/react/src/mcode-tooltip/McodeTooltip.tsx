 ...
 * To use:
 * 1. Mount a Tooltip with some id eg id='mcode-tooltip'
 * 2. Add data-tooltip-id="mcode-tooltip" and data-tooltip-content="Your tooltip text" to any element
 */
export const McodeTooltip = () => {
  ...
  return (
    ...
    <>
			<style>
				{`
				#mcode-tooltip, #mcode-tooltip-orange, #mcode-tooltip-green, #mcode-tooltip-ollama-settings, #mcode-tooltip-provider-info {
					font-size: 12px;
					padding: 0px 8px;
					border-radius: 6px;
					z-index: 999999;
				...
				#mcode-tooltip-ollama-settings, #mcode-tooltip-provider-info {
					background-color: var(--vscode-editor-background);
					color: var(--vscode-input-foreground);
				}
        ...
        delayShow={50} />
			...
			<Tooltip
        id="mcode-tooltip-orange"
        border='1px solid rgba(200,200,200,.3)'
        opacity={1}
        delayShow={50} />
      
			<Tooltip
        id="mcode-tooltip-green"
        border='1px solid rgba(200,200,200,.3)'
        opacity={1}
        delayShow={50} />
      
			<Tooltip
        id="mcode-tooltip-ollama-settings"
        border='1px solid rgba(100,100,100,.2)'
        opacity={1}
        ...
        style={{ pointerEvents: 'all', userSelect: 'text', fontSize: 11 }}>
			...
			<Tooltip
        id="mcode-tooltip-provider-info"
        border='1px solid rgba(100,100,100,.2)'
        opacity={1}
        delayShow={50}
